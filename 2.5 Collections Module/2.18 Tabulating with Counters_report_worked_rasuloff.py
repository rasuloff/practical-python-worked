...
''' Tabulating with Counter formulas are below'''
...
# check the holdings:
holdings # expected result: Counter({'MSFT': 250, 'IBM': 150, 'CAT': 150, 'AA': 100, 'GE': 95})

# get three most held stocks

holdings.most_common(3) # expected result: [('MSFT', 250), ('IBM', 150), ('CAT', 150)]

# Grab another portfolio of stocks and make a new Counter
...
# check the holdings2
holdings2 # expected result: Counter({'HPQ': 250, 'GE': 125, 'AA': 50, 'MSFT': 25})

# combine all the holdings into one

holdings
# expected result: Counter({'MSFT': 250, 'IBM': 150, 'CAT': 150, 'AA': 100, 'GE': 95})
holdings2
# expected result: Counter({'HPQ': 250, 'GE': 125, 'AA': 50, 'MSFT': 25})
combined = holdings + holdings2
combined
# expected result: Counter({'MSFT': 275, 'HPQ': 250, 'GE': 220, 'AA': 150, 'IBM': 150, 'CAT': 150})
